...
export const PRELOAD_FUNC = {
  ...
  SEND_FOR_VERIFICATION: '02_14',
  APPROVE_PROFESSOR_NOVELTY: '02_15',
  SAVE_CONTRACT_MODALITY_PROFESSOR: '02_16',
  PARENT: '02',
} as const;
...
export const CDP_FUNC = {
  ...
  SEND_CDP_REQUEST_TO_VICE: '04_04',
  APROVE_CDP_REQUEST: '04_05',
  PARENT: '04',
} as const;
